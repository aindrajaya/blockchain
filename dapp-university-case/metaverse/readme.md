# Metaverse Tutorial by DApp University

## Projec/Tutorial Explanation
Learn how to create just like [The Sandbox](https://www.sandbox.game/en/) that build a 3D world where you can buy virtual land on the blockchain.
...
## Setting Up
### 1. Download the Repository by using ZIP, and then go to the folder
`$ cd dapp-university-case && cd metaverse`
