...
module.exports = function(getRequest, apiKey){
  return {
    ...
    /**
     * Returns information about a bliock by block number.
     * @param {string} tag - Tag to look up
     * @example
     * var blockNumber = api.proxy.eth_getBlockNumber('0x10d4f');
     * @returns {Promise.<integer>}
     */
     ...
     * @param {string} tag - Tag to took up
    ...
    /**
     * Returns the numbe of transaction in a block from a block matchin the given block number
     * @param {string} tag - Tag to look up
     * @example
     * var res = api.proxy.eth_getBlockTransactionCountByNumbe('0x1231D');
     * @returns {Promise.<object>}
     */
    ...
    /**
     * Returns the information about a transaction requestion by transaction hash
     ...
     * @returns {Promise.<object>}
     */
    eth_getBlockTransactionCountByNumber(tag, index){
      const module = 'proxy';
     ...
     * @param {string} gasPrice - recent gas price
     * @param {string} gas - gas that will be commited to execute a transaction
     * @example
