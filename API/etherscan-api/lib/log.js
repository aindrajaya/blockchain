...
module.exports = function(getRequest, apiKey){
  return {
    /**
   * The event Log API was designed to provide an alternative eth_getLogs
   */
  /**
   * returns the status of a specific transactions hash
  ...
  getLogs(address,
    ...
    topic0_2_opr){
      ...
      var query = querystring.string(params)
