...
module.exports = function(getRequest, apiKey){
  return {
    ...
    /**
     * Get a list of internal transaction
     * @param {string} txhash - Transaction hash. If specified then address will be ignore
    ...
    txlist(address, startblock, endblock, page, offset, sort){
      ...
      var query = querystring.stringify({
        module, action, startblock, endblock, page, offse, sort, address, apiKey
      });
    ...
    /**
     * Get list of blocks that specific account has mined
     * @example
    ...
    tokentx(address, contractaddress, startblock, endblock, page, offset, sort){
      ...
      var queryObject = {
        module, action, startblock, endblock, page, offse, sort, addres, apiKey
      }
    ...
    /**
     * [BETA] Get a list of "ERC721 - Token Transfer Evernts", by address
     * @param {string} address - Account address
     * @param {string} startblock - start looking here
     * @param {string} endblock - end looking there
     * @param {number} page - Page number
     ...
     * @param {string} sort - Sort asc/desc
     * @example
     * var txlist = api.account.tokennfttx('0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae', '0x5F988D968cb76c34C87e6924Cc1Ef1dCd4dE75da', 1, 'latest', 'asc')
     * @returns {Promise.<object>}
     */
